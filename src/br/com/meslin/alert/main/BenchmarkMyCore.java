...
import br.com.meslin.alert.contextnet.BenchmarkMyGroupSelector;
import br.com.meslin.alert.contextnet.BenchmarkMyProcessingNode;
...
public class BenchmarkMyCore {
	...
	public static void main(String[] args) {
		 ...
		 */
		new BenchmarkMyProcessingNode(mobileObjectQueue);
